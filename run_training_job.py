...
parser.add_argument("-t", "--training", help = "Are you training a model in this run: 1 for True 0 for False")
...
test += 1
print("\n----------")
print(f"Extra Test: Trained model vs itself")
print("----------")
p1 = Player("Tom (P1)","FIXED", out_file)
p1.greet()
...
test += 1
print("\n----------")
print(f"Extra Test: Trained model vs the champ")
print("----------")
p1 = Player("Tom (P1)","FIXED", out_file)
p1.greet()
p2 = Player("The Champ (P2)","FIXED", "experiments/20260131_1_well_trained.csv")
p2.greet()
p1_wins, p2_wins, draws, headline = run_training_loop(p1, p2, n_validation, "ALTERNATE", 0)
p1_validation_wins += p1_wins
p1_validation_loses += p2_wins
